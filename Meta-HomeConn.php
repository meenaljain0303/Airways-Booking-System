...
<html>
<head>
	<title>Meta Airways - Flights</title>
	<meta charset="utf-8">
	...
	<link rel="stylesheet" type="text/css" href="Meta-HomeConnCSSn.css">
</head>
<body>
	<!--NavBar-->
					...
					if($_POST['submit'])
					{
						...
						if(mysqli_query($conn,$sql))
						{
							...
							while($row = mysqli_fetch_assoc($print))
							{
								...
								echo "<td><form method='GET' action='Meta-Book.php'>
    									  <input type='hidden' name='varname' value='$var_value'>
    									  <input type='submit' value='BOOK' style='color:black'>
										  </form></td>";
								/*echo "<td><a href='Meta-Book.php?varname=<?php echo $var_value ?>'>Book</a></td>";*/
