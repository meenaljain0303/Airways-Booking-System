...
<head>
  ...
  <link href="https://fonts.googleapis.com/css?family=Pacifico|Paytone+One" rel="stylesheet">
	<link rel="stylesheet" type="text/css" href="Meta-HomeCSSnew.css">
</head>
...
<body>
	...
	<nav class="navbar navbar-inverse">
		<div class="container">
			<div class="navbar-header">
				<a href="#" class="navbar-brand"><img src="4b5d99c4-2f06-45be-88b2-5e4bb39f9885.png" id="logo"> Meta AIRWAYS</a>
			...
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1"">
				<ul class="nav navbar-nav">
					...
					<li><a href="Meta-About.php"><strong>About</strong></a></li>
  ...
  <!--Heading/Moto-->
	<div class="container">
		<div class="row">
			<div class="col-lg-12">
				<div id="content">
					<h1>Experince the ERA of Luxury!</h1>
				</div>
			</div>
		</div>
	</div>
  ...
  <!--Tabs-->
    ...
    <div class="tab-content">
      ...
      <div id="home" class="tab-pane fade in active">
        ...
        <form action="Meta-HomeConn.php" method="POST"> 
      ...
      <div id="menu1" class="tab-pane fade">
        ...
        <form action="Meta-Ticket.php" method="POST">
      ...
      <div id="menu2" class="tab-pane fade">
        ...
        <form action="Meta-FlightStatus.php" method="POST">
  ...
  <!--Login Modal End-->
  <script type="text/javascript" src="Meta-HomeJSnew.js"></script>
</body>
</html>
